...
print "sklearn.version: %s" % (sklearn_version)
...
def bipartition(cluster, maxiter=400, num_runs=4, seed=None):
    ...
    cluster_assignment_sa = gl.SArray(cluster_assignment) # minor format conversion
...
football     = left_child_ice_hockey_football
other_sports = right_child_ice_hockey_football
...
politicians = left_child_scholars_politicians_etc
...
scholars = right_child_scholars_politicians_etc
...
actors_authors = left_child_musicians_artists_etc
...
musicians = right_child_musicians_artists_etc
