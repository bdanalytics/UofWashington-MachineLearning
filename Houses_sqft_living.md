# UofWashington:MachineLearning:House Prices:: price regression:: Houses_sqft_living
bdanalytics  
...
glb_out_pfx <- "Houses_sqft_living_"
...
![](Houses_sqft_living_files/figure-html/set_global_options-1.png) 
...
## 1 import.data          1          0           0 8.89  NA      NA
```
...
![](Houses_sqft_living_files/figure-html/import.data-1.png) 
...
```
##          label step_major step_minor label_minor    bgn    end elapsed
## 1  import.data          1          0           0  8.890 19.583  10.693
## 2 inspect.data          2          0           0 19.584     NA      NA
```
...
![](Houses_sqft_living_files/figure-html/inspect.data-1.png) 
...
![](Houses_sqft_living_files/figure-html/inspect.data-2.png) ![](Houses_sqft_living_files/figure-html/inspect.data-3.png) 

```
##          label step_major step_minor label_minor    bgn    end elapsed
## 2 inspect.data          2          0           0 19.584 31.005  11.421
## 3   scrub.data          2          1           1 31.005     NA      NA
```
...
```
##            label step_major step_minor label_minor    bgn    end elapsed
## 3     scrub.data          2          1           1 31.005 34.965    3.96
## 4 transform.data          2          2           2 34.966     NA      NA
```
...
```
##              label step_major step_minor label_minor    bgn   end elapsed
## 4   transform.data          2          2           2 34.966 35.01   0.044
## 5 extract.features          3          0           0 35.011    NA      NA
```
...
## 5        extract.features          3          0           0 35.011 35.031
## 6 extract.features.string          3          1           1 35.031     NA
##   elapsed
## 5    0.02
## 6      NA
```
...
```
##                         label step_major step_minor label_minor   bgn end
## 1 extract.features.string.bgn          1          0           0 35.06  NA
##   elapsed
## 1      NA
```
...
## 6   extract.features.string          3          1           1 35.031
## 7 extract.features.datetime          3          2           2 35.085
##      end elapsed
## 6 35.084   0.053
## 7     NA      NA
```
...
```
##                           label step_major step_minor label_minor    bgn
## 1 extract.features.datetime.bgn          1          0           0 35.112
##   end elapsed
## 1  NA      NA
```
...
##                       label step_major step_minor label_minor    bgn
## 7 extract.features.datetime          3          2           2 35.085
## 8    extract.features.price          3          3           3 35.123
##      end elapsed
## 7 35.122   0.037
## 8     NA      NA
```
...
```
##                        label step_major step_minor label_minor    bgn end
## 1 extract.features.price.bgn          1          0           0 35.148  NA
##   elapsed
## 1      NA
```
...
```
##                    label step_major step_minor label_minor    bgn    end
## 8 extract.features.price          3          3           3 35.123 35.158
## 9  extract.features.text          3          4           4 35.158     NA
##   elapsed
## 8   0.035
## 9      NA
```
...
```
##                       label step_major step_minor label_minor  bgn end
## 1 extract.features.text.bgn          1          0           0 35.2  NA
##   elapsed
## 1      NA
```
...
```
##                    label step_major step_minor label_minor    bgn   end
## 9  extract.features.text          3          4           4 35.158 35.21
## 10  extract.features.end          3          5           5 35.210    NA
##    elapsed
## 9    0.052
## 10      NA
```
...
![](Houses_sqft_living_files/figure-html/extract.features.end-1.png) 

```
##                   label step_major step_minor label_minor    bgn    end
## 10 extract.features.end          3          5           5 35.210 36.109
## 11  manage.missing.data          4          0           0 36.109     NA
##    elapsed
## 10   0.899
## 11      NA
```
...
```
##                  label step_major step_minor label_minor    bgn    end
## 11 manage.missing.data          4          0           0 36.109 36.429
## 12        cluster.data          5          0           0 36.429     NA
##    elapsed
## 11    0.32
## 12      NA
```
...
```
##                      label step_major step_minor label_minor    bgn    end
## 12            cluster.data          5          0           0 36.429 36.499
## 13 partition.data.training          6          0           0 36.499     NA
##    elapsed
## 12    0.07
## 13      NA
```
...
```
##                      label step_major step_minor label_minor    bgn    end
## 13 partition.data.training          6          0           0 36.499 37.309
## 14         select.features          7          0           0 37.310     NA
##    elapsed
## 13    0.81
## 14      NA
```
...
```
## [1] "cor(sqft.living.cut.fctr, sqft_living)=0.8655"
## [1] "cor(price, sqft.living.cut.fctr)=0.5231"
## [1] "cor(price, sqft_living)=0.7084"
```

```
## Warning in myfind_cor_features(feats_df = glb_feats_df, obs_df =
## glbObsTrn, : Identified sqft.living.cut.fctr as highly correlated with
## sqft_living
```
...
## sqft.living.cut.fctr  0.523122591               0 0.523122591 sqft_living
...
![](Houses_sqft_living_files/figure-html/select.features-1.png) 
...
![](Houses_sqft_living_files/figure-html/select.features-2.png) 
...
```
##              label step_major step_minor label_minor    bgn    end elapsed
## 14 select.features          7          0           0 37.310 41.246   3.936
## 15      fit.models          8          0           0 41.247     NA      NA
```
...
```
##              label step_major step_minor label_minor    bgn end elapsed
## 1 fit.models_0_bgn          1          0       setup 41.736  NA      NA
```
...
```
##                            label step_major step_minor label_minor    bgn
## 1               fit.models_0_bgn          1          0       setup 41.736
## 2 fit.models_0_Max.cor.Y.rcv.*X*          1          1      glmnet 41.781
##      end elapsed
## 1 41.781   0.045
## 2     NA      NA
```
...
![](Houses_sqft_living_files/figure-html/fit.models_0-1.png) 

```
##             Length Class      Mode     
## a0           76    -none-     numeric  
## beta        152    dgCMatrix  S4       
## df           76    -none-     numeric  
## dim           2    -none-     numeric  
...
##   (Intercept)          .pos   sqft_living 
## -4.238721e+04 -3.965666e-01  2.829037e+02 
## [1] "max lambda < lambdaOpt:"
##   (Intercept)          .pos   sqft_living 
## -4.309667e+04 -4.104922e-01  2.833028e+02 
##                           id            feats max.nTuningRuns
## 1 Max.cor.Y.rcv.1X1###glmnet sqft_living,.pos               0
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      0.765                 0.013    0.5018358
##   min.RMSE.fit max.Adj.R.sq.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.OOB
## 1       267015          0.50178    0.4305683     233138.6        0.4302662
```
...
![](Houses_sqft_living_files/figure-html/fit.models_0-2.png) ![](Houses_sqft_living_files/figure-html/fit.models_0-3.png) 
...
##   Primary splits:
##       sqft_living < 3395    to the left,  improve=0.317283700, (0 missing)
##       .pos        < 16227.5 to the left,  improve=0.002594806, (0 missing)
## 
...
##   Primary splits:
##       sqft_living < 2329.5  to the left,  improve=0.2299290000, (0 missing)
##       .pos        < 15291.5 to the left,  improve=0.0007481377, (0 missing)
## 
...
##   Primary splits:
##       sqft_living < 6180    to the left,  improve=0.204036600, (0 missing)
##       .pos        < 199     to the left,  improve=0.002622324, (0 missing)
## 
...
##       .pos        < 17769.5 to the left,  improve=0.004352573, (0 missing)
##   Surrogate splits:
##       .pos < 17763   to the left,  agree=0.695, adj=0.009, (0 split)
## 
...
##                     id            feats max.nTuningRuns
## 1 Max.cor.Y##rcv#rpart sqft_living,.pos               5
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      3.894                 0.131    0.4978572
##   min.RMSE.fit max.Adj.R.sq.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.OOB
...
##      bgn   end elapsed
## 2 41.781 49.31   7.529
## 3 49.311    NA      NA
## [1] "fitting model: Interact.High.cor.Y##rcv#glmnet"
## [1] "    indep_vars: sqft_living,.pos,sqft_living:sqft_living"
## Aggregating results
## Selecting tuning parameters
## Fitting alpha = 0.325, lambda = 1155 on full training set
```

![](Houses_sqft_living_files/figure-html/fit.models_0-4.png) ![](Houses_sqft_living_files/figure-html/fit.models_0-5.png) 

```
##             Length Class      Mode     
## a0           66    -none-     numeric  
## beta        132    dgCMatrix  S4       
## df           66    -none-     numeric  
## dim           2    -none-     numeric  
...
## [1] "min lambda > lambdaOpt:"
##   (Intercept)          .pos   sqft_living 
## -4.814324e+04 -4.156261e-01  2.857407e+02 
## [1] "max lambda < lambdaOpt:"
## [1] "Feats mismatch between coefs_left & rght:"
## [1] "(Intercept)" ".pos"        "sqft_living"
##                                id                                    feats
## 1 Interact.High.cor.Y##rcv#glmnet sqft_living,.pos,sqft_living:sqft_living
##   max.nTuningRuns min.elapsedtime.everything min.elapsedtime.final
## 1              25                      5.201                 0.009
##   max.R.sq.fit min.RMSE.fit max.Adj.R.sq.fit max.R.sq.OOB min.RMSE.OOB
## 1    0.5019258     267061.3        0.5018699    0.4289851     233462.4
##   max.Adj.R.sq.OOB max.Rsquared.fit min.RMSESD.fit max.RsquaredSD.fit
## 1        0.4286821        0.5022302       7379.942        0.005162341
```
...
## [1] "    indep_vars: sqft_living,.pos,.rnorm"
## Aggregating results
## Selecting tuning parameters
## Fitting alpha = 0.55, lambda = 1155 on full training set
```

![](Houses_sqft_living_files/figure-html/fit.models_0-6.png) ![](Houses_sqft_living_files/figure-html/fit.models_0-7.png) 

```
##             Length Class      Mode     
## a0           63    -none-     numeric  
## beta        189    dgCMatrix  S4       
## df           63    -none-     numeric  
## dim           2    -none-     numeric  
...
## obsLevels     1    -none-     logical  
## [1] "min lambda > lambdaOpt:"
##   (Intercept)          .pos        .rnorm   sqft_living 
## -4.895657e+04 -3.821237e-01 -1.122739e+03  2.859844e+02 
## [1] "max lambda < lambdaOpt:"
## [1] "Feats mismatch between coefs_left & rght:"
## [1] "(Intercept)" ".pos"        ".rnorm"      "sqft_living"
##                      id                   feats max.nTuningRuns
## 1 Low.cor.X##rcv#glmnet sqft_living,.pos,.rnorm              25
##   min.elapsedtime.everything min.elapsedtime.final max.R.sq.fit
## 1                      4.324                 0.009    0.5019504
##   min.RMSE.fit max.Adj.R.sq.fit max.R.sq.OOB min.RMSE.OOB max.Adj.R.sq.OOB
## 1     267070.8        0.5018666    0.4287391     233512.7        0.4282843
##   max.Rsquared.fit min.RMSESD.fit max.RsquaredSD.fit
## 1         0.502191       7362.659        0.005177897
```
...
```
##                    label step_major step_minor label_minor    bgn    end
## 4 fit.models_0_Low.cor.X          1          3      glmnet 56.139 62.043
## 5       fit.models_0_end          1          4    teardown 62.044     NA
##   elapsed
## 4   5.904
## 5      NA
```
...
```
##         label step_major step_minor label_minor    bgn    end elapsed
## 15 fit.models          8          0           0 41.247 62.052  20.806
## 16 fit.models          8          1           1 62.053     NA      NA
```
...
```
##              label step_major step_minor label_minor    bgn end elapsed
## 1 fit.models_1_bgn          1          0       setup 63.163  NA      NA
```
...
```
##                label step_major step_minor label_minor    bgn    end
## 1   fit.models_1_bgn          1          0       setup 63.163 63.173
## 2 fit.models_1_All.X          1          1       setup 63.174     NA
##   elapsed
## 1   0.011
## 2      NA
##                label step_major step_minor label_minor    bgn    end
## 2 fit.models_1_All.X          1          1       setup 63.174 63.181
## 3 fit.models_1_All.X          1          2      glmnet 63.181     NA
##   elapsed
## 2   0.007
## 3      NA
## [1] "fitting model: All.X##rcv#glmnet"
## [1] "    indep_vars: sqft_living,sqft.living.cut.fctr,.pos,.rnorm"
## Aggregating results
## Selecting tuning parameters
...
![](Houses_sqft_living_files/figure-html/fit.models_1-1.png) ![](Houses_sqft_living_files/figure-html/fit.models_1-2.png) 
...
##                                  .rnorm 
##                           -1.206655e+03 
## sqft.living.cut.fctr(1.43e+03,1.91e+03] 
##                           -1.309202e+05 
## sqft.living.cut.fctr(1.91e+03,2.55e+03] 
##                           -2.498059e+05 
##  sqft.living.cut.fctr(2.55e+03,1.4e+04] 
##                           -3.314969e+05 
##                             sqft_living 
##                            4.004010e+02 
## [1] "max lambda < lambdaOpt:"
...
## [2] ".pos"                                   
## [3] ".rnorm"                                 
## [4] "sqft.living.cut.fctr(1.43e+03,1.91e+03]"
## [5] "sqft.living.cut.fctr(1.91e+03,2.55e+03]"
## [6] "sqft.living.cut.fctr(2.55e+03,1.4e+04]" 
## [7] "sqft_living"                            
##                  id                                        feats
## 1 All.X##rcv#glmnet sqft_living,sqft.living.cut.fctr,.pos,.rnorm
##   max.nTuningRuns min.elapsedtime.everything min.elapsedtime.final
## 1              25                      3.901                 0.011
##   max.R.sq.fit min.RMSE.fit max.Adj.R.sq.fit max.R.sq.OOB min.RMSE.OOB
## 1    0.5351675     258300.1        0.5350111    0.4518944     228731.2
##   max.Adj.R.sq.OOB max.Rsquared.fit min.RMSESD.fit max.RsquaredSD.fit
## 1         0.451021        0.5347475       5902.895          0.0100119
##                label step_major step_minor label_minor    bgn    end
## 3 fit.models_1_All.X          1          2      glmnet 63.181 68.793
## 4 fit.models_1_All.X          1          3         glm 68.794     NA
##   elapsed
## 3   5.612
## 4      NA
...
![](Houses_sqft_living_files/figure-html/fit.models_1-3.png) ![](Houses_sqft_living_files/figure-html/fit.models_1-4.png) ![](Houses_sqft_living_files/figure-html/fit.models_1-5.png) ![](Houses_sqft_living_files/figure-html/fit.models_1-6.png) 
...
## -2738709   -144977    -28215    105488   3458670  
## 
## Coefficients:
##                                             Estimate Std. Error t value
## (Intercept)                               -1.115e+05  7.060e+03 -15.790
## .pos                                      -5.032e-01  3.757e-01  -1.339
## .rnorm                                    -1.421e+03  1.945e+03  -0.731
## `sqft.living.cut.fctr(1.43e+03,1.91e+03]` -1.350e+05  5.976e+03 -22.588
## `sqft.living.cut.fctr(1.91e+03,2.55e+03]` -2.561e+05  7.272e+03 -35.218
## `sqft.living.cut.fctr(2.55e+03,1.4e+04]`  -3.424e+05  1.120e+04 -30.571
## sqft_living                                4.044e+02  4.402e+00  91.882
##                                           Pr(>|t|)    
## (Intercept)                                 <2e-16 ***
## .pos                                         0.180    
## .rnorm                                       0.465    
## `sqft.living.cut.fctr(1.43e+03,1.91e+03]`   <2e-16 ***
## `sqft.living.cut.fctr(1.91e+03,2.55e+03]`   <2e-16 ***
## `sqft.living.cut.fctr(2.55e+03,1.4e+04]`    <2e-16 ***
## sqft_living                                 <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## (Dispersion parameter for gaussian family taken to be 66548786818)
## 
##     Null deviance: 2.5534e+15  on 17840  degrees of freedom
## Residual deviance: 1.1868e+15  on 17834  degrees of freedom
## AIC: 495259
## 
## Number of Fisher Scoring iterations: 2
## 
##               id                                        feats
## 1 All.X##rcv#glm sqft_living,sqft.living.cut.fctr,.pos,.rnorm
##   max.nTuningRuns min.elapsedtime.everything min.elapsedtime.final
## 1               1                      1.658                 0.052
##   max.R.sq.fit min.RMSE.fit min.aic.fit max.Adj.R.sq.fit max.R.sq.OOB
## 1     0.535195     258299.5    495258.7        0.5350386    0.4513386
##   min.RMSE.OOB max.Adj.R.sq.OOB max.Rsquared.fit min.RMSESD.fit
## 1     228847.2        0.4504642        0.5347668       5820.029
##   max.RsquaredSD.fit
## 1         0.01026911
```
...
```
##                  label step_major step_minor label_minor    bgn    end
## 4   fit.models_1_All.X          1          3         glm 68.794 74.348
## 5 fit.models_1_preProc          1          4     preProc 74.349     NA
##   elapsed
## 4   5.555
## 5      NA
```
...
##                                                                        feats
## Max.cor.Y.rcv.1X1###glmnet                                  sqft_living,.pos
## Max.cor.Y##rcv#rpart                                        sqft_living,.pos
## Interact.High.cor.Y##rcv#glmnet     sqft_living,.pos,sqft_living:sqft_living
## Low.cor.X##rcv#glmnet                                sqft_living,.pos,.rnorm
## All.X##rcv#glmnet               sqft_living,sqft.living.cut.fctr,.pos,.rnorm
## All.X##rcv#glm                  sqft_living,sqft.living.cut.fctr,.pos,.rnorm
##                                 max.nTuningRuns min.elapsedtime.everything
## Max.cor.Y.rcv.1X1###glmnet                    0                      0.765
## Max.cor.Y##rcv#rpart                          5                      3.894
## Interact.High.cor.Y##rcv#glmnet              25                      5.201
## Low.cor.X##rcv#glmnet                        25                      4.324
## All.X##rcv#glmnet                            25                      3.901
## All.X##rcv#glm                                1                      1.658
##                                 min.elapsedtime.final max.R.sq.fit
## Max.cor.Y.rcv.1X1###glmnet                      0.013    0.5018358
## Max.cor.Y##rcv#rpart                            0.131    0.4978572
## Interact.High.cor.Y##rcv#glmnet                 0.009    0.5019258
## Low.cor.X##rcv#glmnet                           0.009    0.5019504
## All.X##rcv#glmnet                               0.011    0.5351675
## All.X##rcv#glm                                  0.052    0.5351950
##                                 min.RMSE.fit max.Adj.R.sq.fit max.R.sq.OOB
## Max.cor.Y.rcv.1X1###glmnet          267015.0        0.5017800    0.4305683
## Max.cor.Y##rcv#rpart                271576.7               NA    0.3939231
## Interact.High.cor.Y##rcv#glmnet     267061.3        0.5018699    0.4289851
## Low.cor.X##rcv#glmnet               267070.8        0.5018666    0.4287391
## All.X##rcv#glmnet                   258300.1        0.5350111    0.4518944
## All.X##rcv#glm                      258299.5        0.5350386    0.4513386
##                                 min.RMSE.OOB max.Adj.R.sq.OOB
## Max.cor.Y.rcv.1X1###glmnet          233138.6        0.4302662
## Max.cor.Y##rcv#rpart                240523.3               NA
## Interact.High.cor.Y##rcv#glmnet     233462.4        0.4286821
## Low.cor.X##rcv#glmnet               233512.7        0.4282843
## All.X##rcv#glmnet                   228731.2        0.4510210
## All.X##rcv#glm                      228847.2        0.4504642
##                                 max.Rsquared.fit min.RMSESD.fit
## Max.cor.Y.rcv.1X1###glmnet                    NA             NA
## Max.cor.Y##rcv#rpart                   0.4858920       4805.365
## Interact.High.cor.Y##rcv#glmnet        0.5022302       7379.942
## Low.cor.X##rcv#glmnet                  0.5021910       7362.659
## All.X##rcv#glmnet                      0.5347475       5902.895
## All.X##rcv#glm                         0.5347668       5820.029
##                                 max.RsquaredSD.fit min.aic.fit
## Max.cor.Y.rcv.1X1###glmnet                      NA          NA
## Max.cor.Y##rcv#rpart                   0.012588873          NA
## Interact.High.cor.Y##rcv#glmnet        0.005162341          NA
## Low.cor.X##rcv#glmnet                  0.005177897          NA
## All.X##rcv#glmnet                      0.010011895          NA
## All.X##rcv#glm                         0.010269108    495258.7
```
...
```
##                  label step_major step_minor label_minor    bgn    end
## 5 fit.models_1_preProc          1          4     preProc 74.349 74.434
## 6     fit.models_1_end          1          5    teardown 74.435     NA
##   elapsed
## 5   0.085
## 6      NA
```
...
```
##         label step_major step_minor label_minor    bgn    end elapsed
## 16 fit.models          8          1           1 62.053 74.446  12.394
## 17 fit.models          8          2           2 74.447     NA      NA
```
...
```
##              label step_major step_minor label_minor    bgn end elapsed
## 1 fit.models_2_bgn          1          0       setup 77.703  NA      NA
```
...
## Max.cor.Y.rcv.1X1###glmnet                    0    0.5018358
## Max.cor.Y##rcv#rpart                          5    0.4978572
## Interact.High.cor.Y##rcv#glmnet              25    0.5019258
## Low.cor.X##rcv#glmnet                        25    0.5019504
## All.X##rcv#glmnet                            25    0.5351675
## All.X##rcv#glm                                1    0.5351950
##                                 max.Adj.R.sq.fit max.R.sq.OOB
## Max.cor.Y.rcv.1X1###glmnet             0.5017800    0.4305683
## Max.cor.Y##rcv#rpart                          NA    0.3939231
## Interact.High.cor.Y##rcv#glmnet        0.5018699    0.4289851
## Low.cor.X##rcv#glmnet                  0.5018666    0.4287391
## All.X##rcv#glmnet                      0.5350111    0.4518944
## All.X##rcv#glm                         0.5350386    0.4513386
##                                 max.Adj.R.sq.OOB max.Rsquared.fit
## Max.cor.Y.rcv.1X1###glmnet             0.4302662               NA
## Max.cor.Y##rcv#rpart                          NA        0.4858920
## Interact.High.cor.Y##rcv#glmnet        0.4286821        0.5022302
## Low.cor.X##rcv#glmnet                  0.4282843        0.5021910
## All.X##rcv#glmnet                      0.4510210        0.5347475
## All.X##rcv#glm                         0.4504642        0.5347668
##                                 inv.elapsedtime.everything
## Max.cor.Y.rcv.1X1###glmnet                       1.3071895
## Max.cor.Y##rcv#rpart                             0.2568053
## Interact.High.cor.Y##rcv#glmnet                  0.1922707
## Low.cor.X##rcv#glmnet                            0.2312673
## All.X##rcv#glmnet                                0.2563445
## All.X##rcv#glm                                   0.6031363
##                                 inv.elapsedtime.final inv.RMSE.fit
## Max.cor.Y.rcv.1X1###glmnet                  76.923077 3.745108e-06
## Max.cor.Y##rcv#rpart                         7.633588 3.682201e-06
## Interact.High.cor.Y##rcv#glmnet            111.111111 3.744459e-06
## Low.cor.X##rcv#glmnet                      111.111111 3.744326e-06
## All.X##rcv#glmnet                           90.909091 3.871466e-06
## All.X##rcv#glm                              19.230769 3.871474e-06
##                                 inv.RMSE.OOB  inv.aic.fit
## Max.cor.Y.rcv.1X1###glmnet      4.289295e-06           NA
## Max.cor.Y##rcv#rpart            4.157601e-06           NA
## Interact.High.cor.Y##rcv#glmnet 4.283344e-06           NA
## Low.cor.X##rcv#glmnet           4.282422e-06           NA
## All.X##rcv#glmnet               4.371944e-06           NA
## All.X##rcv#glm                  4.369729e-06 2.019147e-06
```
...
![](Houses_sqft_living_files/figure-html/fit.models_2-1.png) 
...
## 5               All.X##rcv#glmnet     228731.2    0.4518944
## 6                  All.X##rcv#glm     228847.2    0.4513386
## 1      Max.cor.Y.rcv.1X1###glmnet     233138.6    0.4305683
## 3 Interact.High.cor.Y##rcv#glmnet     233462.4    0.4289851
## 4           Low.cor.X##rcv#glmnet     233512.7    0.4287391
## 2            Max.cor.Y##rcv#rpart     240523.3    0.3939231
##   max.Adj.R.sq.fit min.RMSE.fit
## 5        0.5350111     258300.1
## 6        0.5350386     258299.5
## 1        0.5017800     267015.0
## 3        0.5018699     267061.3
## 4        0.5018666     267070.8
## 2               NA     271576.7
```
...
![](Houses_sqft_living_files/figure-html/fit.models_2-2.png) 
...
## sqft_living                                         100.00000 100.00000
## .pos                                                 99.87922  99.87922
## .rnorm                                               99.51580  99.51580
## sqft.living.cut.fctr(1.43e+03,1.91e+03]              60.43336  60.43336
## sqft.living.cut.fctr(1.91e+03,2.55e+03]              24.61335  24.61335
## sqft.living.cut.fctr(2.55e+03,1.4e+04]                0.00000   0.00000
##                                         All.X##rcv#glmnet.imp
## sqft_living                                         100.00000
## .pos                                                 99.87922
## .rnorm                                               99.51580
## sqft.living.cut.fctr(1.43e+03,1.91e+03]              60.43336
## sqft.living.cut.fctr(1.91e+03,2.55e+03]              24.61335
## sqft.living.cut.fctr(2.55e+03,1.4e+04]                0.00000
```
...
![](Houses_sqft_living_files/figure-html/fit.models_2-3.png) ![](Houses_sqft_living_files/figure-html/fit.models_2-4.png) ![](Houses_sqft_living_files/figure-html/fit.models_2-5.png) ![](Houses_sqft_living_files/figure-html/fit.models_2-6.png) 
...
## 18200               1237819.3                     2062181
## 7433                 863805.1                     1711195
## 11976               1388979.0                     1611021
## 17152                943265.8                     1556734
## 11447               1204689.7                     1545310
...
![](Houses_sqft_living_files/figure-html/fit.models_2-7.png) 
...
## (2.55e+03,1.4e+04]       1281584175         285621.6   4487
## (1.91e+03,2.55e+03]       708146315         158386.6   4471
## (1.43e+03,1.91e+03]       583493872         131773.7   4428
## (0,1.43e+03]              497503530         111673.1   4455
##                     err.abs.OOB.sum err.abs.OOB.mean
## (2.55e+03,1.4e+04]        227803635         261242.7
## (1.91e+03,2.55e+03]       146319371         151941.2
## (1.43e+03,1.91e+03]       124631725         126145.5
## (0,1.43e+03]              108277515         114096.4
##           .n.OOB           .n.Fit           .n.Tst   .freqRatio.Fit 
##           3772.0          17841.0           3772.0              1.0 
##   .freqRatio.OOB   .freqRatio.Tst  err.abs.fit.sum err.abs.fit.mean 
##              1.0              1.0     3070727892.7         687454.9 
##           .n.fit  err.abs.OOB.sum err.abs.OOB.mean 
##          17841.0      607032245.8         653425.8
```
...
```
##              label step_major step_minor label_minor    bgn end elapsed
## 1 fit.models_2_bgn          1          0    teardown 87.595  NA      NA
```
...
```
##         label step_major step_minor label_minor    bgn    end elapsed
## 17 fit.models          8          2           2 74.447 87.606   13.16
## 18 fit.models          8          3           3 87.607     NA      NA
```
...
![](Houses_sqft_living_files/figure-html/fit.models_3-1.png) 
...
```
##                label step_major step_minor label_minor    bgn    end
## 18        fit.models          8          3           3 87.607 95.034
## 19 fit.data.training          9          0           0 95.035     NA
##    elapsed
## 18   7.427
## 19      NA
```
...
```
##                label step_major step_minor label_minor    bgn    end
## 19 fit.data.training          9          0           0 95.035 95.472
## 20 fit.data.training          9          1           1 95.473     NA
##    elapsed
## 19   0.437
## 20      NA
```
...
![](Houses_sqft_living_files/figure-html/fit.data.training_1-1.png) ![](Houses_sqft_living_files/figure-html/fit.data.training_1-2.png) ![](Houses_sqft_living_files/figure-html/fit.data.training_1-3.png) ![](Houses_sqft_living_files/figure-html/fit.data.training_1-4.png) 
...
## 12778 1225069038 20140505T000000 2280000        7      8.00       13540
...
## 12778   307752    3.0         3    12       9410     1999   98053 47.6675
...
## 12778 -121.986          4850     217800 Train -1.4110978 10543
...
## 12778 1225069038#20140505T000000   (2.55e+03,1.4e+04]  Fit          0    4
##       sqft_basement yr_renovated price.All.X..rcv.glmnet
## 3915           2360         2001                 3577345
## 9255           1030            0                 3515338
## 7253           3480         1987                 4381277
## 1316           2390            0                 2515954
## 12778          4130            0                 4977992
##       price.All.X..rcv.glmnet.err price.All.X..rcv.glmnet.err.abs
## 3915                     -3485155                         3485155
## 9255                     -3369662                         3369662
## 7253                     -3318723                         3318723
## 1316                     -2784046                         2784046
## 12778                     2697992                         2697992
...
## 12778                                FALSE 1225069038#20140505T000000
```

![](Houses_sqft_living_files/figure-html/fit.data.training_1-5.png) 
...
![](Houses_sqft_living_files/figure-html/fit.data.training_1-6.png) 
...
```
##                label step_major step_minor label_minor     bgn    end
## 20 fit.data.training          9          1           1  95.473 121.67
## 21  predict.data.new         10          0           0 121.671     NA
##    elapsed
## 20  26.197
## 21      NA
```
...
![](Houses_sqft_living_files/figure-html/predict.data.new-1.png) ![](Houses_sqft_living_files/figure-html/predict.data.new-2.png) ![](Houses_sqft_living_files/figure-html/predict.data.new-3.png) ![](Houses_sqft_living_files/figure-html/predict.data.new-4.png) 
...
![](Houses_sqft_living_files/figure-html/predict.data.new-5.png) 
...
## All.X##rcv#glmnet                   228731.2    0.4518944        0.5350111
## All.X##rcv#glm                      228847.2    0.4513386        0.5350386
## Max.cor.Y.rcv.1X1###glmnet          233138.6    0.4305683        0.5017800
## Interact.High.cor.Y##rcv#glmnet     233462.4    0.4289851        0.5018699
## Low.cor.X##rcv#glmnet               233512.7    0.4287391        0.5018666
## Max.cor.Y##rcv#rpart                240523.3    0.3939231               NA
##                                 min.RMSE.fit
## All.X##rcv#glmnet                   258300.1
## All.X##rcv#glm                      258299.5
## Max.cor.Y.rcv.1X1###glmnet          267015.0
## Interact.High.cor.Y##rcv#glmnet     267061.3
## Low.cor.X##rcv#glmnet               267070.8
## Max.cor.Y##rcv#rpart                271576.7
```

```
## [1] "All.X##rcv#glmnet OOB RMSE: 228731.2061"
```
...
## (2.55e+03,1.4e+04]     872    872   4487    872   4487         261242.7
## (1.91e+03,2.55e+03]    963    963   4471    963   4471         151941.2
## (1.43e+03,1.91e+03]    988    988   4428    988   4428         126145.5
## (0,1.43e+03]           949    949   4455    949   4455         114096.4
##                     err.abs.fit.mean err.abs.new.mean err.abs.trn.mean
## (2.55e+03,1.4e+04]          285621.6         261242.7         285621.6
## (1.91e+03,2.55e+03]         158386.6         151941.2         158386.6
## (1.43e+03,1.91e+03]         131773.7         126145.5         131773.7
## (0,1.43e+03]                111673.1         114096.4         111673.1
##                     err.abs.OOB.sum err.abs.fit.sum err.abs.new.sum
## (2.55e+03,1.4e+04]        227803635      1281584175       227803635
## (1.91e+03,2.55e+03]       146319371       708146315       146319371
## (1.43e+03,1.91e+03]       124631725       583493872       124631725
## (0,1.43e+03]              108277515       497503530       108277515
##                     err.abs.trn.sum
## (2.55e+03,1.4e+04]       1281584175
## (1.91e+03,2.55e+03]       708146315
## (1.43e+03,1.91e+03]       583493872
## (0,1.43e+03]              497503530
##   .freqRatio.Fit   .freqRatio.OOB   .freqRatio.Tst           .n.Fit 
##              1.0              1.0              1.0          17841.0 
##           .n.OOB           .n.Tst           .n.fit           .n.new 
##           3772.0           3772.0          17841.0           3772.0 
##           .n.trn err.abs.OOB.mean err.abs.fit.mean err.abs.new.mean 
##          17841.0         653425.8         687454.9         653425.8 
## err.abs.trn.mean  err.abs.OOB.sum  err.abs.fit.sum  err.abs.new.sum 
##         687454.9      607032245.8     3070727892.7      607032245.8 
##  err.abs.trn.sum 
##     3070727892.7 
##                     .freqRatio.Fit .freqRatio.OOB .freqRatio.Tst .n.Fit
## (2.55e+03,1.4e+04]       0.2514994      0.2311771      0.2311771   4487
...
## (2.55e+03,1.4e+04]          261242.7         285621.6         285621.6
## (1.91e+03,2.55e+03]         151941.2         158386.6         158386.6
## (1.43e+03,1.91e+03]         126145.5         131773.7         131773.7
## (0,1.43e+03]                114096.4         111673.1         111673.1
##                     err.abs.new.mean.x err.abs.new.mean.y err.abs.OOB.sum
## (2.55e+03,1.4e+04]            261242.7           261242.7       227803635
## (1.91e+03,2.55e+03]           151941.2           151941.2       146319371
## (1.43e+03,1.91e+03]           126145.5           126145.5       124631725
## (0,1.43e+03]                  114096.4           114096.4       108277515
##                     err.abs.fit.sum err.abs.trn.sum err.abs.new.sum.x
## (2.55e+03,1.4e+04]       1281584175      1281584175         227803635
## (1.91e+03,2.55e+03]       708146315       708146315         146319371
## (1.43e+03,1.91e+03]       583493872       583493872         124631725
## (0,1.43e+03]              497503530       497503530         108277515
##                     err.abs.new.sum.y
## (2.55e+03,1.4e+04]          227803635
## (1.91e+03,2.55e+03]         146319371
## (1.43e+03,1.91e+03]         124631725
## (0,1.43e+03]                108277515
##     .freqRatio.Fit     .freqRatio.OOB     .freqRatio.Tst 
##                1.0                1.0                1.0 
##             .n.Fit             .n.OOB             .n.Tst 
...
![](Houses_sqft_living_files/figure-html/predict.data.new-6.png) 

```
##                   label step_major step_minor label_minor     bgn     end
## 21     predict.data.new         10          0           0 121.671 156.055
## 22 display.session.info         11          0           0 156.056      NA
##    elapsed
## 21  34.385
## 22      NA
```
...
```
##                        label step_major step_minor label_minor     bgn
## 21          predict.data.new         10          0           0 121.671
## 20         fit.data.training          9          1           1  95.473
## 15                fit.models          8          0           0  41.247
## 17                fit.models          8          2           2  74.447
## 16                fit.models          8          1           1  62.053
## 2               inspect.data          2          0           0  19.584
## 1                import.data          1          0           0   8.890
## 18                fit.models          8          3           3  87.607
## 3                 scrub.data          2          1           1  31.005
## 14           select.features          7          0           0  37.310
## 10      extract.features.end          3          5           5  35.210
## 13   partition.data.training          6          0           0  36.499
## 19         fit.data.training          9          0           0  95.035
## 11       manage.missing.data          4          0           0  36.109
## 12              cluster.data          5          0           0  36.429
## 6    extract.features.string          3          1           1  35.031
## 9      extract.features.text          3          4           4  35.158
## 4             transform.data          2          2           2  34.966
## 7  extract.features.datetime          3          2           2  35.085
## 8     extract.features.price          3          3           3  35.123
## 5           extract.features          3          0           0  35.011
##        end elapsed duration
## 21 156.055  34.385   34.384
## 20 121.670  26.197   26.197
## 15  62.052  20.806   20.805
## 17  87.606  13.160   13.159
## 16  74.446  12.394   12.393
## 2   31.005  11.421   11.421
## 1   19.583  10.693   10.693
## 18  95.034   7.427    7.427
## 3   34.965   3.960    3.960
## 14  41.246   3.936    3.936
## 10  36.109   0.899    0.899
## 13  37.309   0.810    0.810
## 19  95.472   0.437    0.437
## 11  36.429   0.320    0.320
## 12  36.499   0.070    0.070
## 6   35.084   0.053    0.053
## 9   35.210   0.052    0.052
## 4   35.010   0.044    0.044
## 7   35.122   0.037    0.037
## 8   35.158   0.035    0.035
## 5   35.031   0.020    0.020
## [1] "Total Elapsed Time: 156.055 secs"
```

![](Houses_sqft_living_files/figure-html/display.session.info-1.png) 
